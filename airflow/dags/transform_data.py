...
file_path = "/opt/airflow/data/raw/customer_orders_raw_100k.csv"
...
valid_df.to_csv(
    "/opt/airflow/data/processed/cleaned_orders.csv",
    index=False
)

rejected_df.to_csv(
    "/opt/airflow/data/processed/rejected_orders.csv",
    index=False
)
...
with open(
    "/opt/airflow/data/processed/etl_metrics.json",
    "w"
) as metrics_file:
